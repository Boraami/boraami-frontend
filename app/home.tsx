...
function App() {
  return (
    <View>
      ...
      <Text fontFamily="$PoppinsReg" fontStyle="italic" fontSize={"$xl"}>
        Poppins Regular Italic - g
      </Text>
      <Text fontFamily="$PoppinsMed" fontSize={"$xl"}>
        Poppins Medium - g
      </Text>
      <Text fontFamily="$PoppinsMed" fontStyle="italic" fontSize={"$xl"}>
        Poppins Medium Italic - g
      </Text>
      <Text fontFamily="$heading" fontSize={"$xl"}>
        Poppins Bold - g
      </Text>
      <Text fontFamily="$heading" fontStyle="italic" fontSize={"$xl"}>
